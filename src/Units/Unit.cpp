...
Mech::Mech(const int x,const int y,const int team) : Unit(UnitType::MECH, MovementType::MECH, x, y, 17 * 16, 6 * 16, team, 2, 3,0, 70, 70,
                                          3, 3000) {}

// ggf anderer TireType
Recon::Recon(const int x,const int y,const int team) : Unit(UnitType::RECON, MovementType::TIRE_A, x, y, 18 * 16, 6 * 16, team, 8, 1,0,
                                            80, 80, 8, 4000) {}

Tank::Tank(int x, int y, int team) : Unit(UnitType::TANK, MovementType::TREAD, x, y, 19 * 16, 6 * 16, team, 6, 1,0, 99, 99,
                                          9, 7000) {}

MediumTank::MediumTank(int x, int y, int team) : Unit(UnitType::MEDIUM_TANK, MovementType::TREAD, x, y, 20 * 16, 6 * 16,
                                                      team, 5, 1,0, 70, 70, 8, 12000) {}

APC::APC(int x, int y, int team) : Unit(UnitType::APC, MovementType::TREAD, x, y, 21 * 16, 6 * 16, team, 6, 1,0, 70, 70, 8,
                                        5000) {}

Artillery::Artillery(int x, int y, int team) : Unit(UnitType::ARTILLERY, MovementType::TREAD, x, y, 22 * 16, 6 * 16,
                                                    team, 5, 2,0, 99, 99, 9, 6000) {}

Rocket::Rocket(int x, int y, int team) : Unit(UnitType::ROCKET, MovementType::AIR, x, y, 23 * 16, 6 * 16, team, 5, 3,0, 99,
                                                99, 9, 15000) {}
...
BattleCopter::BattleCopter(int x, int y, int team) : Unit(UnitType::BATTLE_COPTER, MovementType::AIR, x, y, 26 * 16,
                                                              6 * 16, team, 6, 1,0, 99, 99, 9, 9000) {}

TransportCopter::TransportCopter(int x, int y, int team) : Unit(UnitType::TRANSPORT_COPTER, MovementType::AIR, x, y,
                                                                    27 * 16, 6 * 16, team, 6, 0,0, 99, 99, 9,
                                                                    5000) {}

Fighter::Fighter(int x, int y, int team) : Unit(UnitType::FIGHTER, MovementType::AIR, x, y, 28 * 16, 6 * 16, team, 9, 1,0,
                                                  99, 99, 9, 20000) {}

Bomber::Bomber(int x, int y, int team) : Unit(UnitType::BOMBER, MovementType::AIR, x, y, 29 * 16, 6 * 16, team, 7, 1,0, 99,
                                                99, 9, 22000) {}

Lander::Lander(int x, int y, int team) : Unit(UnitType::LANDER, MovementType::SEA, x, y, 30 * 16, 6 * 16, team, 6, 0,0, 99,
                                                99, 9, 12000) {}

Cruiser::Cruiser(int x, int y, int team) : Unit(UnitType::CRUISER, MovementType::SEA, x, y, 31 * 16, 6 * 16, team, 5, 0,0,
                                                  99, 99, 9, 18000) {}
